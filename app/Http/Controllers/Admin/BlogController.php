...
class BlogController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.blogs.create', compact('blog_categories', 'created_bies', 'tags'));
    }
    ...
    public function edit(Blog $blog)
    {
        ...
        $blog->load('blog_category', 'created_by', 'tags');

        return view('admin.blogs.edit', compact('blog_categories', 'created_bies', 'tags', 'blog'));
    }
    ...
    public function show(Blog $blog)
    {
        ...
        $blog->load('blog_category', 'created_by', 'tags', 'blogComments');
