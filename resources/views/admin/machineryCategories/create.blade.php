...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.machineryCategory.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.machinery-categories.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cost_per_hour') ? 'is-invalid' : '' }}" type="number" name="cost_per_hour" id="cost_per_hour" value="{{ old('cost_per_hour', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cost_per_day') ? 'is-invalid' : '' }}" type="number" name="cost_per_day" id="cost_per_day" value="{{ old('cost_per_day', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cost_per_week') ? 'is-invalid' : '' }}" type="number" name="cost_per_week" id="cost_per_week" value="{{ old('cost_per_week', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cost_per_month') ? 'is-invalid' : '' }}" type="number" name="cost_per_month" id="cost_per_month" value="{{ old('cost_per_month', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('two_way_delivery') ? 'is-invalid' : '' }}" type="number" name="two_way_delivery" id="two_way_delivery" value="{{ old('two_way_delivery', '0') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_rental_price_incl_taxes_before') ? 'is-invalid' : '' }}" type="number" name="total_rental_price_incl_taxes_before" id="total_rental_price_incl_taxes_before" value="{{ old('total_rental_price_incl_taxes_before', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_rental_price_incl_taxes_after') ? 'is-invalid' : '' }}" type="number" name="total_rental_price_incl_taxes_after" id="total_rental_price_incl_taxes_after" value="{{ old('total_rental_price_incl_taxes_after', '0') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('manufacture_year') ? 'is-invalid' : '' }}" type="text" name="manufacture_year" id="manufacture_year" value="{{ old('manufacture_year', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('digging_depth') ? 'is-invalid' : '' }}" type="text" name="digging_depth" id="digging_depth" value="{{ old('digging_depth', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('maximum_digging_force') ? 'is-invalid' : '' }}" type="text" name="maximum_digging_force" id="maximum_digging_force" value="{{ old('maximum_digging_force', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rated_power') ? 'is-invalid' : '' }}" type="text" name="rated_power" id="rated_power" value="{{ old('rated_power', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('standard_bucket_capacity') ? 'is-invalid' : '' }}" type="text" name="standard_bucket_capacity" id="standard_bucket_capacity" value="{{ old('standard_bucket_capacity', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('standard_bucket_width') ? 'is-invalid' : '' }}" type="text" name="standard_bucket_width" id="standard_bucket_width" value="{{ old('standard_bucket_width', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('operation_hydraulic_pressure') ? 'is-invalid' : '' }}" type="text" name="operation_hydraulic_pressure" id="operation_hydraulic_pressure" value="{{ old('operation_hydraulic_pressure', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gradeadility') ? 'is-invalid' : '' }}" type="text" name="gradeadility" id="gradeadility" value="{{ old('gradeadility', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pressure_to_the_ground') ? 'is-invalid' : '' }}" type="text" name="pressure_to_the_ground" id="pressure_to_the_ground" value="{{ old('pressure_to_the_ground', '') }}">
