                ...
                <tbody>
                    @foreach($aboutus as $key => $aboutu)
                        <tr data-entry-id="{{ $aboutu->id }}">
                            ...
                            <td>
                                @can('aboutu_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.aboutus.show', $aboutu->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan
                                ...
                                @can('aboutu_delete')
                                    <form action="{{ route('admin.aboutus.destroy', $aboutu->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('aboutu_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.aboutus.massDestroy') }}",
...
@endcan
  ...
  let table = $('.datatable-Aboutu:not(.ajaxTable)').DataTable({ buttons: dtButtons })
