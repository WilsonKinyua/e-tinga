    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.bookings.update", [$booking->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('customer') ? 'is-invalid' : '' }}" type="text" name="customer" id="customer" value="{{ old('customer', $booking->customer) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="number" name="phone" id="phone" value="{{ old('phone', $booking->phone) }}" step="1">
                @if($errors->has('phone'))
                    <div class="invalid-feedback">
                        {{ $errors->first('phone') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('equipment') ? 'is-invalid' : '' }}" type="text" name="equipment" id="equipment" value="{{ old('equipment', $booking->equipment) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('order_start_date') ? 'is-invalid' : '' }}" type="text" name="order_start_date" id="order_start_date" value="{{ old('order_start_date', $booking->order_start_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('order_end_date') ? 'is-invalid' : '' }}" type="text" name="order_end_date" id="order_end_date" value="{{ old('order_end_date', $booking->order_end_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_cost') ? 'is-invalid' : '' }}" type="number" name="total_cost" id="total_cost" value="{{ old('total_cost', $booking->total_cost) }}" step="0.01" required>
